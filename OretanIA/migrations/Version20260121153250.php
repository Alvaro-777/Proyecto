 ...
 */
final class Version20260121153250 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE historial_uso_ia (id INT AUTO_INCREMENT NOT NULL, usuario_id INT NOT NULL, ia_id INT NOT NULL, archivo_id INT DEFAULT NULL, texto_input VARCHAR(255) DEFAULT NULL, fecha DATETIME NOT NULL, ip VARCHAR(45) DEFAULT NULL, INDEX IDX_D9EF0CB4DB38439E (usuario_id), INDEX IDX_D9EF0CB4489A6E65 (ia_id), UNIQUE INDEX UNIQ_D9EF0CB446EBF93B (archivo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE prediccion (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE usuario (id INT AUTO_INCREMENT NOT NULL, correo VARCHAR(100) NOT NULL, pswd VARCHAR(100) NOT NULL, nombre VARCHAR(50) NOT NULL, apellido VARCHAR(50) NOT NULL, creditos INT DEFAULT 50, fecha_registro DATETIME DEFAULT NULL, foto_perfil VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_2265B05D77040BC9 (correo), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE prediccion');
